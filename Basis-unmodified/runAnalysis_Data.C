...
R__LOAD_LIBRARY(AliAnalysisTaskAntiProtons_vs_Rapidity_Data_Local_cxx.so)
...
#define AnalysisTask    "AliAnalysisTaskAntiProtons_vs_Rapidity_Data_Local"
#define TTL             20000
...
void LoadAnalysisTask (Int_t iChunk, AliAnalysisManager *mgr)  {
    ...
    //Load Analysis Task
    gROOT->LoadMacro("AliAnalysisTaskAntiProtons_vs_Rapidity_Data_Local.cxx+g");
    ...
    //Analysis Task
    AliAnalysisTaskAntiProtons_vs_Rapidity_Data_Local *task = new AliAnalysisTaskAntiProtons_vs_Rapidity_Data_Local ("task_AntiProtons_vs_y");
    task -> SelectCollisionCandidates (AliVEvent::kINT7);
    task -> AliAnalysisTaskAntiProtons_vs_Rapidity_Data_Local::SetITSRecalibrationMaps (hITSnsigma_Mean,hITSnsigma_Width);
    task -> AliAnalysisTaskAntiProtons_vs_Rapidity_Data_Local::SetRunningMode(isITSrecalib,runData,matchingEff);
    mgr -> AddTask(task);
...
//______________________________________________________________________________________________________________________________________________________
void runAnalysis_Data (Int_t iChunk=0, const char *mode="full", Bool_t merge=kTRUE)  {
