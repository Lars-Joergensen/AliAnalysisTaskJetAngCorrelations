#ifndef AliAnalysisTaskAntiProtons_vs_Rapidity_Data_Local_cxx
#define AliAnalysisTaskAntiProtons_vs_Rapidity_Data_Local_cxx
...
class AliAnalysisTaskAntiProtons_vs_Rapidity_Data_Local : public AliAnalysisTaskSE {
        
public:
    AliAnalysisTaskAntiProtons_vs_Rapidity_Data_Local();
    AliAnalysisTaskAntiProtons_vs_Rapidity_Data_Local(const char *name);
    virtual ~AliAnalysisTaskAntiProtons_vs_Rapidity_Data_Local();
...
private:
    ...
    AliAnalysisTaskAntiProtons_vs_Rapidity_Data_Local(const AliAnalysisTaskAntiProtons_vs_Rapidity_Data_Local&);
    AliAnalysisTaskAntiProtons_vs_Rapidity_Data_Local& operator=(const AliAnalysisTaskAntiProtons_vs_Rapidity_Data_Local&);
        
    ClassDef(AliAnalysisTaskAntiProtons_vs_Rapidity_Data_Local, 1);
