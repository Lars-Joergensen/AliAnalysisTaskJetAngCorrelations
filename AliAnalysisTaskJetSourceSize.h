#ifndef AliAnalysisTaskJetSourceSize_cxx
#define AliAnalysisTaskJetSourceSize_cxx
...
class AliAnalysisTaskJetSourceSize : public AliAnalysisTaskSE {

public:
    AliAnalysisTaskJetSourceSize();
    AliAnalysisTaskJetSourceSize(const char *name);
    virtual ~AliAnalysisTaskJetSourceSize();
...
private:
    ...
    AliAnalysisTaskJetSourceSize(const AliAnalysisTaskJetSourceSize&);
    AliAnalysisTaskJetSourceSize& operator=(const AliAnalysisTaskJetSourceSize&);

    ClassDef(AliAnalysisTaskJetSourceSize, 1);
